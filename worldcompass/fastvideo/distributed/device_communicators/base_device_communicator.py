...
class DistributedAutograd:
    ...
    all_gather, and all_to_all. Each operation is implemented as a static inner class with proper
    ...
    class AllReduce(torch.autograd.Function):
        ...
        The gradient of all_reduce is another all_reduce operation since the operation combines
        values from all ranks equally.
        """
    ...
    class AllGather(torch.autograd.Function):
        ...
        The operation gathers tensors from all ranks and concatenates them along a specified
        dimension. The backward pass uses reduce_scatter to efficiently distribute gradients back to
        source ranks.
        """
        ...
        def forward(
            ...
            if scatter_dim == 2 and gather_dim == 1:
                ...
                input_ = input_.transpose(
                    0, 2
                ).contiguous()  # hn, shard_seqlen, bs, hd
                ...
                input_ = input_.transpose(
                    0, 2
                ).contiguous()  # shard_hn, seqlen, bs, hd
...
class DeviceCommunicatorBase:
    ...
    def all_reduce(
        ...
        return DistributedAutograd.AllReduce.apply(
            self.device_group, input_, op
        )
