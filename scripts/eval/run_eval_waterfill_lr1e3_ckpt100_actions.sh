#!/bin/bash
# Evaluate LoRA waterfill_right11_lr1e3 checkpoint-100 on tank_filling_up with multiple actions (9:16)
...
LORA_CKPT=/data/ziqi/Repos/HY-WorldPlay-New/outputs/lora_waterfill_right11_lr1e3/checkpoint-100/transformer/diffusion_pytorch_model.safetensors
IMAGE_PATH=/data/ziqi/data/worldstate/predynamic/tank_filling_up.png

OUTPUT_BASE=/data/ziqi/Repos/HY-WorldPlay-New/outputs/eval_waterfill_lr1e3_ckpt100_actions
...
for i in "${!ACTIONS[@]}"; do
  ...
  echo "  Checkpoint: lora_waterfill_right11_lr1e3/checkpoint-100"
