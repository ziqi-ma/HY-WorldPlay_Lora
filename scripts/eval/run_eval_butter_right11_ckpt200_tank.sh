#!/bin/bash
# Evaluate LoRA butter_right11 checkpoint-200 on tank_filling_up image with 9:16 aspect ratio
...
OUTPUT_DIR=/data/ziqi/Repos/HY-WorldPlay-New/outputs/eval_butter_right11_ckpt200_tank
export CUDA_VISIBLE_DEVICES=0,1,2,3
N_INFERENCE_GPU=4

echo "==========================================="
echo "  Evaluating: right-11 on tank_filling_up"
echo "  Checkpoint: checkpoint-200"
echo "  Resolution: 768x432 (9:16 portrait)"
