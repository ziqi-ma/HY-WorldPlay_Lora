#!/bin/bash
# Evaluate checkpoint-3000 on 3 seen + 3 unseen trajectories using GPUs 4-7.
...
CKPT=outputs/butter4_temporal_embed_per_block_all20/checkpoint-3000
TEMPORAL_EMBED_CKPT=$CKPT/transformer/diffusion_pytorch_model.safetensors
OUT_BASE=outputs/eval_per_block_ckpt3000
