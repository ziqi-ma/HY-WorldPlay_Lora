#!/bin/bash
# Evaluate LoRA waterfill_right11 checkpoint-400 on butter image (16:9) with right-11 motion
...
LORA_CKPT=/data/ziqi/Repos/HY-WorldPlay-New/outputs/lora_waterfill_right11/checkpoint-400/transformer/diffusion_pytorch_model.safetensors
IMAGE_PATH=/data/ziqi/data/worldstate/predynamic/butter2_ini.jpeg

OUTPUT_DIR=/data/ziqi/Repos/HY-WorldPlay-New/outputs/eval_waterfill_right11_ckpt400_butterimg
export CUDA_VISIBLE_DEVICES=0,1,2,3
N_INFERENCE_GPU=4

echo "==========================================="
echo "  Evaluating: right-11 on butter image (16:9)"
echo "  Checkpoint: lora_waterfill_right11/checkpoint-400"
