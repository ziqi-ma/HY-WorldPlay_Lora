#!/bin/bash
# Evaluate LoRA waterfill_right11_lr1e3 checkpoint-200 on tank_filling_up with multiple actions (9:16)
...
LORA_CKPT=/data/ziqi/Repos/HY-WorldPlay-New/outputs/lora_waterfill_right11_lr1e3/checkpoint-200/transformer/diffusion_pytorch_model.safetensors
IMAGE_PATH=/data/ziqi/data/worldstate/predynamic/tank_filling_up.png

OUTPUT_BASE=/data/ziqi/Repos/HY-WorldPlay-New/outputs/eval_waterfill_lr1e3_ckpt200_actions
export CUDA_VISIBLE_DEVICES=0,1,2,3
N_INFERENCE_GPU=4

ACTIONS=("left-11" "up-11" "down-11")
TAGS=("left11" "up11" "down11")
...
for i in "${!ACTIONS[@]}"; do
  ...
  echo "  Checkpoint: lora_waterfill_right11_lr1e3/checkpoint-200"
