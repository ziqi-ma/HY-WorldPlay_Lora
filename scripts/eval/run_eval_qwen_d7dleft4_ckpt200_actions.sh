#!/bin/bash
# Evaluate LoRA butter_qwen_d7dleft4 checkpoint-200 on butter2_ini with multiple actions
...
OUTPUT_BASE=/data/ziqi/Repos/HY-WorldPlay-New/outputs/eval_qwen_d7dleft4_ckpt200_actions
export CUDA_VISIBLE_DEVICES=0,1,2,3
N_INFERENCE_GPU=4

ACTIONS=("d-11" "right-11" "down-11" "up-11" "left-11")
TAGS=("d11" "right11" "down11" "up11" "left11")
