#!/bin/bash
# Evaluate LoRA butter_right11 checkpoint-200 on tank_filling_up image with down-11 motion, 9:16 aspect ratio
...
OUTPUT_DIR=/data/ziqi/Repos/HY-WorldPlay-New/outputs/eval_butter_down11_ckpt200_tank
export CUDA_VISIBLE_DEVICES=0,1,2,3
N_INFERENCE_GPU=4

echo "==========================================="
echo "  Evaluating: down-11 on tank_filling_up"
